...
public:
	...
	Error open_in_external_editor(const Ref<Script> &p_script, int p_line, int p_col) override { return ERR_UNAVAILABLE; }
	bool overrides_external_editor() override { return false; }

	Error complete_code(const String &p_code, const String &p_path, Object *p_owner, List<CodeCompletionOption> *r_options, bool &r_force, String &r_call_hint) override { return ERR_UNAVAILABLE; }

	Error lookup_code(const String &p_code, const String &p_symbol, const String &p_path, Object *p_owner, LookupResult &r_result) override { return ERR_UNAVAILABLE; }
